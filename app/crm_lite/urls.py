...
urlpatterns = [
    ...
    path('supplies/<int:pk>/get-invoice/', views.GetInvoiceView.as_view()),
    ...
    path('sales/create/', views.CreateSaleView.as_view(), name='create-sale'),
    path('sales/list/', views.ListSalesView.as_view()),
    path('sales/<int:pk>/update/', views.UpdateSaleView.as_view()),
    path('sales/<int:pk>/delete/', views.DeleteSaleView.as_view()),
    path('sales/analytics/', views.GetAnalyticsView.as_view()),
]
